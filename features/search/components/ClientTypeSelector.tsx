...
const clientTypes = [
  { value: "solar", label: "Instaladores de Paneles Solares", description: "Empresas especializadas en instalación de sistemas solares" },
  { value: "industrial", label: "Empresas Industriales", description: "Sector industrial y manufacturero" },
  { value: "energy", label: "Compañías Energéticas", description: "Empresas del sector energético y utilities" },
  { value: "residential", label: "Sector Residencial", description: "Desarrolladores y constructores residenciales" },
  { value: "commercial", label: "Sector Comercial", description: "Empresas y edificios comerciales" },
  { value: "consulting", label: "Consultorías Energéticas", description: "Consultores especializados en eficiencia energética" },
]

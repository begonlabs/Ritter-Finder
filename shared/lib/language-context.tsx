...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "scraping.total.sites": "Total de Sitios",
    "scraping.total.sites.desc": "Sitios web analizados",
    "scraping.success.rate": "Tasa de Éxito",
    "scraping.success.rate.desc": "Extracción exitosa de datos",
    "scraping.avg.time": "Tiempo Promedio",
    "scraping.avg.time.desc": "Por sitio web",
    "scraping.leads.found": "Leads Encontrados",
    "scraping.leads.found.desc": "Total de contactos extraídos",
  ...
  en: {
    ...
    "dashboard.stats.searches": "Searches Performed",
    "dashboard.stats.searches.desc": "Total AI-powered searches executed",
    "dashboard.stats.openrate": "Open Rate",
    "dashboard.stats.openrate.desc": "Email campaign performance",
    "dashboard.trend.title": "Lead Acquisition Trends",
    "dashboard.trend.subtitle": "Leads found vs. contacted per month",
    ...
    "search.websites.empty": "No websites found.",
    ...
    "search.analyzing": "Analyzing: {website}",

    // Search steps
    "search.step.1": "Initializing AI scraper...",
    "search.step.2": "Connecting to websites...",
    "search.step.3": "Analyzing site structures...",
    ...
    "results.campaign.button": "Create Email Campaign",

    // History
    "history.search.title": "Search History",
    "history.search.desc": "View and re-run your previous searches",
    ...
    "website.greenenergy": "Green Energy Companies",
    ...
    "onboarding.search.description":
      "Select the websites to search and the target client type. Our AI will analyze these sites to find relevant contacts.",
    "onboarding.results.title": "Lead Results",
    "onboarding.results.description":
      "Review the found leads, select the most relevant ones, and prepare personalized email campaigns.",
    "onboarding.campaigns.title": "Email Campaigns",
    "onboarding.campaigns.description":
      "Create personalized email campaigns for your selected leads. Use templates and variables to customize your messages.",
    "onboarding.history.title": "History & Analytics",
    "onboarding.history.description":
      "Access your search and campaign history. Analyze performance with detailed metrics.",
    ...
    "scraping.total.sites": "Total Sites",
    "scraping.total.sites.desc": "Websites analyzed",
    "scraping.success.rate": "Success Rate",
    "scraping.success.rate.desc": "Successful data extraction",
    "scraping.avg.time": "Average Time",
    "scraping.avg.time.desc": "Per website",
    "scraping.leads.found": "Leads Found",
    "scraping.leads.found.desc": "Total contacts extracted",
  ...
  de: {
    ...
    "login.demo": 'Demo-Modus: Verwenden Sie einen beliebigen Benutzernamen mit Passwort "1234"',
    ...
    // Dashboard
    "dashboard.stats.leads": "Leads Gesamt",
    "dashboard.stats.leads.desc": "Leads aus allen Suchen gefunden",
    "dashboard.stats.campaigns": "Kampagnen Gesendet",
    "dashboard.stats.campaigns.desc": "E-Mail-Kampagnen zugestellt",
    "dashboard.stats.searches": "Suchen Durchgeführt",
    "dashboard.stats.searches.desc": "Insgesamt ausgeführte KI-Suchen",
    "dashboard.stats.openrate": "Öffnungsrate",
    "dashboard.stats.openrate.desc": "E-Mail-Kampagnen-Performance",
    "dashboard.trend.title": "Lead-Akquisitionstrends",
    "dashboard.trend.subtitle": "Gefundene vs. kontaktierte Leads pro Monat",
    "dashboard.trend.found": "Leads Gefunden",
    "dashboard.trend.contacted": "Leads Kontaktiert",
    "dashboard.activity": "Letzte Aktivitäten",
    "dashboard.activity.desc": "Ihre letzten Aktionen und Updates",
    ...
    "search.websites.empty": "Keine Websites gefunden.",
    ...
    "search.analyzing": "Analysiere: {website}",

    // Search steps
    "search.step.1": "KI-Scraper initialisieren...",
    "search.step.2": "Verbindung zu Websites...",
    "search.step.3": "Website-Strukturen analysieren...",
    "search.step.4": "Kontaktinformationen extrahieren...",
    "search.step.5": "Nach Zielkriterien filtern...",
    "search.step.6": "E-Mail-Adressen validieren...",
    "search.step.7": "Lead-Daten kompilieren...",
    "search.step.8": "Ergebnisse finalisieren...",
    ...
    "history.search.found": "Leads Gefunden",
    ...
    "history.email.desc": "Verfolgen Sie Ihre E-Mail-Kampagnen-Performance",
    ...
    "client.solar": "Solar-Installateure",
    "client.energy": "Energieberater",
    "client.residential": "Wohnbauunternehmer",
    "client.commercial": "Gewerbeimmobilienverwalter",

    // Websites
    "website.solarinstallers": "Solar-Installateure",
    "website.greenenergy": "Grüne Energie Unternehmen",
    ...
    "email.campaign.desc": "Verfassen Sie Ihre E-Mail für {count} ausgewählte Leads",
    "email.recipients": "Empfänger",
    "email.content": "E-Mail-Inhalt",
    "email.placeholders": "Verwenden Sie [Contact Name] und [Company Name] als Platzhalter, die automatisch ersetzt werden.",
    ...
    "onboarding.welcome.description":
      "Entdecken Sie, wie unsere KI-gestützte Plattform Ihnen dabei helfen kann, hochwertige Leads im Bereich erneuerbare Energien zu finden und zu kontaktieren.",
    "onboarding.search.title": "Lead-Suche",
    "onboarding.search.description":
      "Wählen Sie die zu durchsuchenden Websites und den Zielkundentyp aus. Unsere KI analysiert diese Sites, um relevante Kontakte zu finden.",
    "onboarding.results.title": "Lead-Ergebnisse",
    "onboarding.results.description":
      "Überprüfen Sie die gefundenen Leads, wählen Sie die relevantesten aus und bereiten Sie personalisierte E-Mail-Kampagnen vor.",
    "onboarding.campaigns.title": "E-Mail-Kampagnen",
    "onboarding.campaigns.description":
      "Erstellen Sie personalisierte E-Mail-Kampagnen für Ihre ausgewählten Leads. Verwenden Sie Vorlagen und Variablen, um Ihre Nachrichten anzupassen.",
    "onboarding.history.title": "Verlauf & Analytik",
    "onboarding.history.description":
      "Greifen Sie auf Ihren Such- und Kampagnenverlauf zu. Analysieren Sie die Performance mit detaillierten Metriken.",
    "onboarding.next": "Weiter",
    "onboarding.previous": "Zurück",
    "onboarding.skip": "Überspringen",
    "onboarding.finish": "Fertigstellen",
    "onboarding.email.title": "E-Mail-Komposition",
    "onboarding.email.description":
      "Passen Sie Ihre E-Mails mit vordefinierten Vorlagen an. Sie können Variablen wie [Contact Name] und [Company Name] verwenden.",

    // Scraping Stats
    "scraping.title": "Scraping-Statistiken",
    "scraping.total.sites": "Websites Gesamt",
    "scraping.total.sites.desc": "Analysierte Websites",
    "scraping.success.rate": "Erfolgsrate",
    "scraping.success.rate.desc": "Erfolgreiche Datenextraktion",
    "scraping.avg.time": "Durchschnittszeit",
    "scraping.avg.time.desc": "Pro Website",
    "scraping.leads.found": "Leads Gefunden",
    "scraping.leads.found.desc": "Insgesamt extrahierte Kontakte",
